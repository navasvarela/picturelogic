CREATE TABLE pictures (thumbnail TEXT, description TEXT, filename NUMERIC, id INTEGER PRIMARY KEY, path TEXT, volumeid NUMERIC, raw_exif TEXT, width NUMERIC, height NUMERIC, twidth NUMERIC, theight NUMERIC);
